...
import { FourChoiceShortsVideo } from './FourChoiceShorts';
import { fourChoiceData, titleData as fcTitleData, subtitleData as fcSubtitleData, FourChoiceScene } from './FourChoiceData';
...
import {
  HumanOriginsExplainVideo,
  TOTAL_FRAMES as humanOriginsFrames,
  HumanOriginsExplainPart1,
  PART1_FRAMES as humanOriginsPart1Frames,
  HumanOriginsExplainPart2,
  PART2_FRAMES as humanOriginsPart2Frames,
  HumanOriginsExplainPart3,
  PART3_FRAMES as humanOriginsPart3Frames,
} from './HumanOriginsExplain';
import { LineCtaShortsVideo, LINE_CTA_DURATION } from './LineCtaShorts';
import './style.css';
...
// 4択クイズの総フレーム数を計算
const calculateFourChoiceFrames = (scenes: FourChoiceScene[]) => {
  const countdownDuration = 90; // 3秒 - 4択を読む時間
  return scenes.reduce((acc, scene, index) => {
    const isLast = index === scenes.length - 1;
    const answerBuffer = isLast ? 0 : 45;
...
export const RemotionRoot: React.FC = () => {
  ...
  const fourChoiceTotalFrames = calculateFourChoiceFrames(fourChoiceData);
  ...
  return (
    <>
      ...
      */}
      ...
      <Composition
        id="FourChoiceShorts"
        component={FourChoiceShortsVideo}
        durationInFrames={fourChoiceTotalFrames}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{
          ...
          title: fcTitleData,
          subtitle: fcSubtitleData,
        }}
        calculateMetadata={({ props }) => {
          const scenes = props.scenes || fourChoiceData;
          const duration = calculateFourChoiceFrames(scenes);
          return { durationInFrames: duration };
        }}
      />
      ...
      <Composition
        id="LineCtaShorts"
        component={LineCtaShortsVideo}
        durationInFrames={LINE_CTA_DURATION}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{}}
      ...
      {/* ▼▼▼ 解説動画: 人類の進化 (HumanOriginsExplain) ▼▼▼ */}
      <Composition
        id="HumanOriginsExplain"
        component={HumanOriginsExplainVideo}
        durationInFrames={humanOriginsFrames}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{}}
      />
      <Composition
        id="HumanOriginsExplainPart1"
        component={HumanOriginsExplainPart1}
        durationInFrames={humanOriginsPart1Frames}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{}}
      />
      <Composition
        id="HumanOriginsExplainPart2"
        component={HumanOriginsExplainPart2}
        durationInFrames={humanOriginsPart2Frames}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{}}
      />
      <Composition
        id="HumanOriginsExplainPart3"
        component={HumanOriginsExplainPart3}
        durationInFrames={humanOriginsPart3Frames}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{}}
