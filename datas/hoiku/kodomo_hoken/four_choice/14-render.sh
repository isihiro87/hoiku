...
cp "$BASE/audios/14-00-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-01-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-02-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-03-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-04-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-05-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-06-voice.wav" "$TEMP_DIR/audio/explain/"
cp "$BASE/audios/14-07-voice.wav" "$TEMP_DIR/audio/explain/"
...
echo "=== 14 子どもの身体的発育・発達と保健⑨ (4択) レンダリング開始 ==="
